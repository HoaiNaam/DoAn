...
if(isset($_POST['update'])){
   ...
   if(!empty($image)){
      if($image_size > 2000000){
         $message[] = 'Hình ảnh món ăn quá to!';
      }else{
...
<section class="update-product">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <input type="text" required placeholder="nhập tên món ăn" name="name" maxlength="100" class="box" value="<?= $fetch_products['name']; ?>">
      <span>Cập nhật giá</span>
      <input type="number" min="0" max="9999999999" required placeholder="Nhập giá món ăn" name="price" onkeypress="if(this.value.length == 10) return false;" class="box" value="<?= $fetch_products['price']; ?>">
